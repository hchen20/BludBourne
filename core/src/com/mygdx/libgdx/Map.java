...
import com.mygdx.libgdx.sfx.ParticleEffectFactory;
...
public abstract class Map {
    ...
    protected final static String SPAWNS_LAYER = "MAP_SPAWNS_LAYERS";
    ...
    public final static String LIGHTMAP_DAWN_LAYER = "MAP_LIGHT_LAYER_DAWN";
    ...
    public final static String LIGHTMAP_NIGHT_LAYER = "MAP_LIGHTMAP_LAYER-NIGHT";
    ...
    protected MapLayer _spawnLayer = null;
    ...
    Map(MapFactory.MapType mapType, String fullMapPath) {
        ...
        _spawnLayer = _currentMap.getLayers().get(SPAWNS_LAYER);
        if (_spawnLayer == null)
        ...
        if (_questDiscoverLayer == null)
            Gdx.app.debug(TAG, "No quest discovery layer!");
        ...
        if (_lightMapNightLayer == null)
            Gdx.app.debug(TAG, "No night lightmap found!");
    ...
    public MapLayer get_lightMapNightLayer() {
    ...
    public Array<Vector2> getParticleEffectSpawnPositions(ParticleEffectFactory.ParticleEffectType particleEffectType) {
        ...
        for (MapObject object: _particleEffectSpawnLayer.getObjects()) {
            ...
            if (name == null || !name.equalsIgnoreCase(particleEffectType.toString()))
                continue;
            ...
            // Scale by unit to convert from map coordinates
            x *= UNIT_SCALE;
            y *= UNIT_SCALE;
    ...
    public Array<Vector2> getQuestItemSpawnPosition(String objectName, String objectTaskID) {
        Array<MapObject> objects = new Array<MapObject>();
        Array<Vector2> positions = new Array<Vector2>();
    ...
    public Array<Entity> get_mapEntities() {
        return _mapEntities;
    }

    public Array<Entity> get_mapQuestEntities() {
    ...
    private void setClosestPlayerStartPosition(final Vector2 position) {
        ...
        // Get the last known position on this map
        _playerStartPositionRect.set(0, 0);
        _closestPlayerStartPosition.set(0, 0);
        float shortestDistance = 0f;

        // Go through all player start positions and choose the last known position
        for (MapObject object : _spawnLayer.getObjects()) {
            String objectName = object.getName();
    ...
    public void setClosestStartPositionFromScaledUnits(Vector2 position) {
        ...
        setClosestPlayerStartPosition(_convertedUnits);
    }
